...
namespace HealthTracking.Common.BLL
{
    using DAL;
    using HealthTracking.Common.Response;
    using System.Linq.Expressions;

    public class GenericSvc<D, T> : IGenericSvc<T> where T : class where D : IGenericRep<T>
    {
        #region -- Implements --
